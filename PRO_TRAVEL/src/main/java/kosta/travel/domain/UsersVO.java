...
public class UsersVO{
	...
	public UsersVO(){}
	public UsersVO(String u_id, String u_pwd, String u_name, String u_birth, String u_sex, String u_address,
			String u_job, String u_lang, String u_religion, String u_license, String u_img, String u_style,
			String u_status, MultipartFile img_file) {
		super();
		this.u_id = u_id;
		this.u_pwd = u_pwd;
		this.u_name = u_name;
