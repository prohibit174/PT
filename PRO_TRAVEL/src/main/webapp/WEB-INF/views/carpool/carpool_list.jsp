...
<section class="results ajax-area" data-tmpl="athleteResults_tmpl">
        ...
        <ul class="table2 ajax-content">
            <li>
                    <div class="th col-first"> NOC </div>
                    <div class="th col1"> Medalists </div>
                    <div class="th col2"> Sports </div>
                    <div class="th col4"> Medals </div>
            </li>
...
<span class="mask"></span>
    ...
    <a href="/marit-bjoergen">
<picture class="picture">
<!--[if IE 9]><video style="display: none;"><![endif]-->

<source srcset="https://stillmed.olympic.org/media/Images/OlympicOrg/Athletes/B/Bjoergen_Marit/Bjoergen_Marit_mugshot.jpg?interpolation=lanczos-none&resize=45:45, https://stillmed.olympic.org/media/Images/OlympicOrg/Athletes/B/Bjoergen_Marit/Bjoergen_Marit_mugshot.jpg?interpolation=lanczos-none&resize=90:90 2x" media="(min-width: 1024px)">
<source srcset="https://stillmed.olympic.org/media/Images/OlympicOrg/Athletes/B/Bjoergen_Marit/Bjoergen_Marit_mugshot.jpg?interpolation=lanczos-none&resize=45:45, https://stillmed.olympic.org/media/Images/OlympicOrg/Athletes/B/Bjoergen_Marit/Bjoergen_Marit_mugshot.jpg?interpolation=lanczos-none&resize=90:90 2x" media="(min-width: 768px)">
<!--[if IE 9]></video><![endif]-->

<img srcset="https://stillmed.olympic.org/media/Images/OlympicOrg/Athletes/B/Bjoergen_Marit/Bjoergen_Marit_mugshot.jpg?interpolation=lanczos-none&resize=45:45, https://stillmed.olympic.org/media/Images/OlympicOrg/Athletes/B/Bjoergen_Marit/Bjoergen_Marit_mugshot.jpg?interpolation=lanczos-none&resize=90:90 2x" alt="BJOERGEN Marit ">
<span class="mask"></span>
</picture>
        <div class="area">
            <strong class="name">Marit BJOERGEN</strong>
        </div>
    </a>
                </div>
                <div class="td col2">
        ...
        <div class="area">
            <strong>Cross Country Skiing</strong>
        </div>
                </div>
                <div class="td col4">
