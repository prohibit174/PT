								...
								<tr valign="top">
									<!-- <td><span style="font-family: Arial; font-size: 13px;">Reduced
											...
											Reduced price Children : aged 6-16 <em>(sports clubs,
												camps, etc.)</em> <br /> Reduced price Pupils : aged 6-16 <br />
											Reduced price Children under 6 <em>(sports clubs,
												nursery school, camps, etc.)</em> <br /> <br /> (&loz;)
											Accompanying adult with a disabled person <br /> (*)
											Accompanying adult: 1 for 1-10 pupils, 2 for 11-20 pupils,
						...
						<div>
							<span style="font-family: Arial; font-size: 13px;"> <!-- <p class="p1">
								...
								group rates are for you! <br /> <a target="_blank"
									href="https://stillmed.olympic.org/media/Document%20Library/Museum/Visit/Touristic-Partners/TOM-flyer-TO-2016-ENG.pdf">For
									more information, please download our offer here</a>
							</p>
							<p class="p1">
								Sie sind ein Verein, ein Sportclub oder wollen Sie den
								Olympischen Museum in einer Gruppe oder mit Ihrer Familie
								besuchen? Dann sind unsere Gruppenpreise und Pauschalangebote
								genau was Sie suchen! <br /> <a target="_blank"
									href="https://stillmed.olympic.org/media/Document%20Library/Museum/Visit/Touristic-Partners/TOM-flyer-TO-2016-GER.pdf">Weitere
									Informationen hier</a>
							</p> <br /> <strong><img height="44" alt="Audio guide icon"
								width="45"
							...
							<p>
								Available in French<br /> <img alt=""
									src="https://stillmed.olympic.org/media/Images/Museum/General/PICTS_GOTO_small_BLUE.png" /><a
									href="/museum/visit/practical-information/facilities-and-services-for-people-with-a-disability">See
									Facilities and Services for Disabled People</a>
							</p>
							<p>
				...
				<div class="block">
					...
					<div itemtype="http://schema.org/PostalAddress" itemscope=""
						...
						<p>We answer your calls Monday to Friday from 8:30 am to 12:30
							and from 1:30 pm to 5:30 pm.</p>
						<p>
							The Olympic Museum<br /> 1, quai d'Ouchy<br /> 1006 Lausanne<br />
							Switzerland<br /> T : +41 21 621 65 11
						</p>
						<p>
					...
					<!-- <li class="flip-box"><a href="/museum/visit/tom-cafe"
						target=""> <picture> [if IE 9]><video style="display: none;"><![endif]
							...
							[if IE 9]></video><![endif] <img
								...
								<h1 style="text-transform: uppercase;">TOM Caf&#233;</h1>
								<p>Feel like a snack? Stop off at the TOM caf&#233;, open
