...
<body>
   ...
   <div id="wrapper" data-speed="3">
      ...
      <div class="wrapper-content">
         ...
         <form role="form" method="post" action="/blog/makeBlog" enctype="multipart/form-data" >
...
<!--                               <tr>
                              ...
                              <tr>
                                 <td class="label"><label for="u_lang">Blog Introduction</label></td>
                                 <td class="value"><input type="text" name="b_introduction"
                                    id="b_introduction" value="" /></td>
                              </tr>

                              <tr>
                                 <td class="label"><label for="u_lang">Profile Image</label></td>
                                 <td class="value"><input type="file" name="file2" id="b_img" value="" /> &nbsp; <span class="mandatory"></span></td>
                              </tr>
