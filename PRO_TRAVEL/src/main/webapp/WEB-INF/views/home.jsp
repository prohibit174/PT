				...
				<c:forEach items="${list}" var="list" varStatus="status">
					<c:choose>
						<c:when test="${status.count%3==1}">
							<li itemscope="" itemtype="http://schema.org/ImageObject"
								class="same-height same-height-left " style="height: 367px;">
								<a href="/product/product_detail${pageMaker.makeSearch(pageMaker.cri.page) }&p_num=${list.p_num }" target="_blank">
									<picture class="img"> <img
										src="/resources/upload/${list.p_img }" alt=""></picture>
							</a>
								<h1>
									<a href="/product/product_detail${pageMaker.makeSearch(pageMaker.cri.page) }&p_num=${list.p_num }" target="_blank">${list.p_name}</a>
								</h1> <!-- <span class="sss-picture"></span> --> <span>${list.p_name }</span>
							</li>
						</c:when>

						<c:when test="${status.count%3==2 }">
							<li class="same-height" style="height: 367px;"><a
								href="/product/product_detail${pageMaker.makeSearch(pageMaker.cri.page) }&p_num=${list.p_num }" target="_blank"> <picture
										class="img"> <img
										src="/resources/upload/${list.p_img }" alt=""></picture>
							</a>
								<h1>
									<a href="/blog/myBlog?u_id=${list.u_id }" target="_blank">${list.p_name }</a>
								</h1> <!-- <span class="sss-picture"></span> --> <span>${list.p_name }</span>
							</li>
						</c:when>
						...
						<c:otherwise>
							<li itemscope="" itemtype="http://schema.org/ImageObject"
								class="same-height same-height-right" style="height: 367px;">
								<a href="/blog/myBlog?u_id=${list.u_id }" target="_blank">
									<picture class="img"> <img
										src="/resources/upload/${list.p_img }" alt=""></picture>
							</a>
								<h1>
