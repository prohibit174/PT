...
<div id="footer">
	...
	<div class="holder">
		...
		<form
			action="https://secure.registration.olympic.org/en/newsletter/?email="
			class="sign-form">
			<fieldset>
				<legend class="hide">sign form</legend>
				<label for="text1">Sign up for our newsletter</label>
				<div class="area">
					<input type="submit" value="Go" onclick="openPopup();return false;" />
					<div class="area2">
						<i class="ss-mail"></i> <input type="text" id="email"
