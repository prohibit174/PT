...
<body>
   <div id="sidebar" style="margin-top: 50px";>
      <span class="tabs-section alt" id="tabsSection" style="height: 0px"; >
         ...
         <div id="highlights-of-the-games" /> <section class="text-post"
            itemscope itemtype="http://schema.org/NewsArticle"> </section>
