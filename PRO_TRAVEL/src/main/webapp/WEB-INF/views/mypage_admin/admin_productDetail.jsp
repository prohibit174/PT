...
<link media="all" rel="stylesheet" type="text/css"
 ...
 <script type="text/javascript">
   ...
   function btn_js_delete_click(){
         ...
         /* if(check == true) else false */
         if(check) document.location.href="productDelete?p_num=${product.p_num}";
       }
      ...
      <div class="items active">
         ...
         <div class="row">
                  <c:choose>
                   ...
                   <button type="submit" class="btn btn-danger" id="removeBtn" onclick="btn_js_delete_click()">삭제</button>  </span>      
                     </c:when>
                   <c:otherwise>
